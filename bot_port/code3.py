...
def gen_markup(rows):
    markup = ReplyKeyboardMarkup(one_time_keyboard=True)  # Клавиатура исчезнет после нажатия
    markup.row_width = 1
    for row in rows:
...
/delete - удали проект, если он больше не нужен ❌
/update_projects - обнови информацию о проекте 🔄
/skills - добавь навыки к проекту 🛠️
/info - посмотри список команд, которые я поддерживаю 📜
""")
